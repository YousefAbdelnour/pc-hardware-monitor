...
You may install and use the official, unmodified compiled releases of this app at no charge for personal use.

You may not:

- modify, patch, or repackage the released binaries
- redistribute, mirror, resell, sublicense, or bundle the released binaries with another product or service
- use the app's name, branding, screenshots, or icon as part of another app or derivative product
- claim the app or its code as your own work
